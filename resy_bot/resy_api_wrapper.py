...
class ResyApiRequestWrapper(object):
    """
    Helper function that builds REST requests to make against Tron nodes and handles rate limiting errors more gracefully.
    """
